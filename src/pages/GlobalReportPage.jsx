...
const GlobalReportPage = () => {
  ...
  }, [filterType, customDate, customMonth, refreshKey]);
                  ...
                  <table className="responsive-table report-table">
                    ...
                    <tbody>
                      {data.progressTasks.map(task => (
                        <tr key={task.id} onClick={() => setSelectedTask({ id: task.id, projectId: task.projectId || task.project?.id })} style={{ cursor: 'pointer' }} className="hoverable-row">
